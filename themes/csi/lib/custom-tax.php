 ...
 */
function hair_make_cpt($plural, $singlular, $slug, $url, $order = 5, $icon = 'dashicons-admin-post', $supports = array('title', 'editor', 'thumbnail'))
{
...
{
    hair_make_cpt('Projects', 'Project', 'project', 'projects', 6, 'dashicons-admin-tools', array('title', 'excerpt', 'editor', 'thumbnail'));
    hair_make_cpt('Team', 'Team', 'team', 'team', 20, 'dashicons-admin-users');
    hair_make_cpt('Careers', 'Career Position', 'career', 'careers', 22, 'dashicons-networking');
}
...
{
    hair_make_tax('Levels', 'Team Level', 'team-level', 'team-level', array('team'));
}
