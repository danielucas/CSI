<head>
	...
	<!-- icons & favicons -->
	<link rel="apple-touch-icon" sizes="120x120" href="<?= get_template_directory_uri(); ?>/dist/images/apple-touch-icon.png">
	...
	<link rel="mask-icon" href="<?= get_template_directory_uri(); ?>/dist/images/safari-pinned-tab.svg" color="#000000">
